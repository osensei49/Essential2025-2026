...
const students=[
{
    name:"gypy",
    video:null,
    letter:`Hiiiii Maam Jed,

Thank you for being our second mother, Maam. I truly admire you so much. The way you handle your emotions and mood so well is really inspiring. Ive learned a lot from you Maam, and Im also very happy because Ive gained so many interesting lessons.

Thank you so much Maam Jed.
...

{
    name:"Maria",
    video:null,
    letter:`Dear Maam Jed,

The day of our recognition has finally arrived. For the past few days and months, all we could say was unta wa nay klase! hapit na bakasyon! or kapoi adto skwelahan, but then realization hits. You will no longer be our adviser next school year, and gusto ko na lang bawion ang mga days nga ga dali ko, na I kept on wishing na unta mana ni nga S.Y. Now, I’m starting to accept all of it, even though its kind of sting na dili na ikaw amoang adviser, wala man mi mabuhat huhu. Kung pwede lang gyud maam na ikaw lang gihapun among adviser sa G12 ignon gyud namo si maam Van hehe, eme lang hehehehe. 

But, really. Thank you, Ma’am Jed. You have really help us a lot, weve learned so much from you. And honestly, I dont know if makaya nako akong first year as senior high school students kung wala imong guidance. You have given us warmth and comfort just by being our adviser, youve helped me concur my fears in starting this new phase of my lives, and helped me build myself for the days to come. You shave played a massive role in shaping our lives. Thank you pud ma’am, for coping with our ka-sabaan, ka-oahan, ka-badlongon, and ka-kulitan. Sorry if we were such a headache sa imoha and yet you still didnt give up on us. THANKYOUU MAAM. 

Thank you so much for being with us through this hard yet full of knowledge journey maam Jed. I will always be grateful knowing I once had you as my adviser. I wish you all the best ma’am, may you find happiness and peace in everything you do. LOVE YOU MAAM!!

Sincerely,Maria Lylle Zhyrell U. Chee kee

P. Sorry kayo sa mga punctuations maam huhu`
},
...
Once again, thank you so much, Maam Jed. I am truly grateful to have you as my teacher. 
...
Salamat kaayo, Maam Jed, sa tanan. Amping pirmi, ug hinaot padayon pa nimo ma-inspire ang daghan pang estudyante sama nako.
...

{
    name:"Stephany",
    video:null,
    letter:`To our dearest Maam Jed,

Hi, Maam Jed!

First of all, gusto nako mag-thank you. Thank you so, so, sooo much, Maam. Not just for being our teacher, but also for being a sisterly figure to us.

Actually, I always saw you at school during my Junior High School years, and to be honest, at first gyud kay wala ko nag-expect nga maestra diay ka kay mura gyud kag student. No joke, ga-blend in man gyud ka sa mga students, Ma'am.Pero pagka first day of school in Senior High, nakurat ko kay ikaw among adviser. Despite that, Im really thankful and relieved at the same time. Feel man gyud nako kay you’re the kind of teacher nga dali ra ma-close sa students, dali ra maduulan, understanding, og considerate, and I was right about that.

Even though unsa mi kabadlungon (which I admit nga tinood gyud), you always find it in your heart to forgive us. No matter how big our mistakes are, or how many times weve given you headaches, made you cry, and everything. You always try to understand us and scold us (in a good way, of course).

And sorry kaayo, Maam, kay na-handle gyud mi nimo. The worst batch ever. Aware man gyud ko nga sa tanan nimong na-handle, kami gyud ang pinaka-labad, and Im not proud of it. Usahay gani kay maulaw nako nimo kay pirme nalang gyud mi agka-mention sa GC sa mga maestra. Yes, Ma'am. I know about that, si Sir Chee Kee man gyud gaingon saamo. So, Im really sorry gyud, Maam. 

Fun fact bitaw, Maam. I already expected that Senior High School would turn my life upside down, but because of you, it only turned 360°. It was still hard, challenging, pressuring (especially since I’m surrounded by competitive people), stressful, and even depressing. But despite all that, I was able to handle it. Not perfectly, but enough for me to not completely lose my mind. And all of this wouldn’t feel like okay ra, kaya raman diay if it wasn’t for your guidance and endless lectures.
...
Bye, Maam! Unta okay ra nga mubisita mi inig Grade 12 diha, especially if need namo magpa-print HAHAHAH.

Thats all. We love you, Maam/Ate Jed! 
...

{
    name:"lovely",
    video:null,
    letter:`Hi maammmm! Sa tinuod lang maam wala jud koy maistorya nga mga churvaels  kundi THANK YOU ra jud maam hehe. Salamat sa taas nga pasensya nga imong gihatag saamo maam  (feel jud nako maam kay napuno na jud kas amo sorry ma'am ). Thank you pod maam sa pagpasabot saamo og tarong sa mga lesson nga imong ag-itudlo, masabtan gyud sya maam no jokeee hehe tas sa imong mga advices nga dili gyud intawon namo agkahimo, sorry maam. Sorry pod diay maam kay dili namo agkamaintain ang kahinlo saamong area . Mao rana akong maingon maam hehe thank youu kaayo gyud sa all! God bless you always maammmm `
},
